...
La cuarta, sería analizar nuestro proyecto con Boxplots, esto es para poder comparar junto con el primer análisis más detallado y ver como se comporta en términos de probabilidad nuestros datos y poder hacer una comparación objetiva.
...
Se descargo cada PDF de la información de las mordeduras de perro y se convirtieron a formato Excel para más adelante poderlos pasar a formato CSV para poder hacer nuestros análisis en Rstudio.
...
Consideramos prescindible para entender el proyecto explicar como se encuentran los datos: 
...
En cada tabla se encuntran columnas indicando: Estado, Año, Sexo(General, Hombres o Mujeres), Fuente(Fuente de Notificación, Mes de Ocurrencia o Grupo de Edad) y Total de Mordeduras. 
