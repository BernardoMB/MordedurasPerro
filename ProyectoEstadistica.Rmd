---
title: "Proyecto"
author: "Fernando Chávez, Bernardo Mondragón, Rayan García"
...
```{r , echo=TRUE}
workingDirectory <- "/Users/fchavezga/Desktop/MordedurasPerro"
...
## Listas y Creación del Dataframe "mpData"
...
## Creación de DataFrame (Para poder leer la pirámide de Fuente De Notificación)
...
## Creación de la Pirámide de Fuente de Notificación
```{r , echo=TRUE}
#Creacion Piramide 1
...
## Creación de DataFrame (Para poder leer la pirámide de Grupo De Edad)
```{r , echo=TRUE, message=FALSE, warning=FALSE, results='hide'}
...
## Creación de la Pirámide de Grupo de Edad
```{r , echo=TRUE}
#Pirámide hombres y mujeres, por estado y grupo de edad
...
## Creación de DataFrame (Para poder leer la pirámide de Mes de Ocurrencia)
```{r , echo=TRUE, message=FALSE, warning=FALSE, results='hide'}
...
## Creación de la Pirámide de Mes de Ocurrencia
```{r , echo=TRUE}
...
# Tendencia de las Mordeduras a través de los años
```{r , echo=TRUE}
